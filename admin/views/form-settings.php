...
<div class = "captcha" style="margin-left:20px;"> 
    ...
    <div class="form-group col-md-12">
        ...
        <div class="col-md-4">        
             ...
             <?php if($captcha_config['smack_recaptcha']=='no' || !isset($captcha_config['smack_recaptcha'])) { echo "checked"; } ?> onclick="showOrHideRecaptchaPRO('no');"> 
             <label for="smack_recaptcha_no"  id="innertext"  class="leads-builder-label mr10"> <?php echo esc_html__('No' , 'wp-leads-builder-any-crm' ); ?>
             </label>
             <input type='radio'  name='smack_recaptcha' id='smack_recaptcha_yes'  value="yes"<?php if($captcha_config['smack_recaptcha']=='yes') { echo "checked"; } ?> onclick="showOrHideRecaptchaPRO('yes');">
...
<div id="recaptcha_public_key"
    <?php 
        if($captcha_config['smack_recaptcha']=='no' || !isset($captcha_config['smack_recaptcha']))
                {
...
>    <div class="form-group col-md-12">
	<div style="margin-left:33%; color:red"> Upgrade to PRO</div>
         <div class="col-md-3">
             <label id="innertext" class="leads-builder-label"><?php echo esc_html__('Google Recaptcha Public Key' , 'wp-leads-builder-any-crm' ); ?>  <?php echo str_repeat( '&nbsp;' , 50 );?>   </label>
         </div>
