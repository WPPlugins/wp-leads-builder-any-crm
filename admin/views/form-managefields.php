...
$activatedplugin = $lb_admin->getActivatedPlugin();
		    ...
		    if(isset($shortcode))
		    {
             ...
             <input type='hidden' id='rr_first_userid' value="<?php echo $first_userid ;?>">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="errormessage" value="<?php if(isset($config_fields->error_message)) echo $config_fields->error_message; ?>" placeholder ="<?php echo esc_html__("Sorry, submission failed. Kindly try again after some time" , SM_LB_URL ); ?>" />
                        </div>
                        <div>
